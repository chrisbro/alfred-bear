...
## Install
To install, download a [released alfred-bear workflow](https://github.com/chrisbro/alfred-bear/releases/download/0.2.0/alfred-bear.alfredworkflow) and double-click to open in Alfred 3. Easy-peasy.
